package Alatar::PostgreSQL::Extractors::PgTableExtractor;

use strict;
use String::Util qw(trim);
use Data::Dumper;
use Alatar::PostgreSQL::Extractors::PgColumnExtractor;
...
sub _extractObject {
	...
	$this->{entity} = Alatar::Model::SqlTable->new($this->{owner},$name);
	...
	foreach my $item (@items) {
		$columnExtractor = Alatar::PostgreSQL::Extractors::PgColumnExtractor->new($this->{entity},$item);
